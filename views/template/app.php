...
<body>
    ...
    <div class="container">
        ...
        <div class="menu">
            ...
            <div class="bar"></div>
            <nav>
                <a class="nav-link" href="/index" target="" rel="noopener noreferrer"><img class="nav-icon"
                        src="https://img.icons8.com/?size=100&id=82767&format=png&color=ffffff" alt=""></a>
                <a class="nav-link" href="/historico" target="" rel="noopener noreferrer"><img class="nav-icon"
                        src="https://img.icons8.com/?size=100&id=86125&format=png&color=ffffff" alt=""></a>
                <a class="nav-link" href="/perfil" target="_blank" rel="noopener noreferrer"><img class="nav-icon"
